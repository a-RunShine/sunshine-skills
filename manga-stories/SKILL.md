...
- 不问"画什么"——故事已经给
- 不问"几页"——默认 8
- 必问 1 个：风格细化（写实 / 简化 / 复古 / 萌系）
- 必问 1 个：anchor 页是哪一张（让用户挑或 AI 推荐）
- 可选问：有没有真实人物 / 参考图
- **2-3 问搞定**
...
- 不问"风格"——已经说了
- 不问"画什么"——故事给了
- 必问 1 个：故事具体讲什么（用户可能还没讲，要让他说）
- 必问 1 个：anchor 选在哪（暗恋哪一帧最想画好）
- 可选问：要不要彩色页 / 几张
- **2-3 问搞定**

**场景 C：用户说"想画个故事但没灵感"**

- 这时候**多问**——但问的是"你想要什么感觉的故事"而不是"故事范围"
- 问 1：什么情绪？（治愈 / 燃 / 丧 / 甜）
- 问 2：什么题材？（追星 / 暗恋 / 友情 / 日常 / 圆梦）
...
- 张数（默认 8，看故事长度可调）
- 故事范围（默认整篇，除非用户说"只画一段"）
- 是否系列（默认单期）
- 标签方向（用户自己会写）
- 画面尺寸（默认 3:4 竖版）
- 是否需要 caption box（**永远要，不接受关掉**）
